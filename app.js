...
const drugDescriptionDeleteNoticeRouter = require('./routes/drug_descriptions/deleteNotice');
// posologies
...
app.use('/drug-descriptions/delete-notice', drugDescriptionDeleteNoticeRouter);
// hospitals
